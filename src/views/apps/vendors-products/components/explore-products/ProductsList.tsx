...
export default function ProductList() {
  const { unAssignedProducts, unAssignProductsLoading } = useContext(VendorsProductsCxt)
  ...
  return (
    <Grid container>
      ...
      {Array.isArray(unAssignedProducts) &&
...
const ProductCard = ({ product }: { product: Product }) => {
  ...
  const { handleRefreshUnassignedProducts } = useContext(VendorsProductsCxt)
  ...
  const handleAssignProduct = async () => {
    ...
    axios
      ...
      .then(() => {
        ...
        toast.success('Product assigned to you successfully')
      })
      .catch(() => {
        toast.error('Assign Product Faild')
      })
      .finally(() => {
        setLoading(false)
      })
