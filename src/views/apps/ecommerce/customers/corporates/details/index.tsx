...
// const OverViewTab = dynamic(() => import('@views/apps/ecommerce/customers/corporates/details/customer-right/overview'))
// const SecurityTab = dynamic(() => import('@views/apps/ecommerce/customers/corporates/details/customer-right/security'))
// // const NotificationsTab = dynamic(
// //   () => import('@views/apps/ecommerce/customers/corporates/details/customer-right/notification')
// // )

// const AddressBillingTab = dynamic(
//   () => import('@views/apps/ecommerce/customers/corporates/details/customer-right/address-billing')
// )
